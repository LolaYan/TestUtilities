...
public class SauceLabIOSDriverBrowserSample {
	...
	public void setUp() throws MalformedURLException {
		...
		caps.setCapability("name", "IOS browser Test");
	...
	public static void main(String[] args) throws MalformedURLException {
		SauceLabIOSDriverBrowserSample sample = new SauceLabIOSDriverBrowserSample();
		sample.setUp();
