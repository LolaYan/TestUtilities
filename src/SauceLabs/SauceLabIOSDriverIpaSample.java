...
public class SauceLabIOSDriverIpaSample {
	...
	public void setUp() throws MalformedURLException {
		...
		caps.setCapability("app","sauce-storage:LottoNZ.zip");
		caps.setCapability("name", "IOS zip Test");

		// ondemand.saucelabs.com:80
		// 192.168.200.70:4445

		this.driver = new IOSDriver(new URL("http://" + username + ":" + key
				+ "@192.168.200.70:4445/wd/hub"), caps);
		this.wait = new WebDriverWait(driver, 120);
		this.jobId = ((RemoteWebDriver) this.driver).getSessionId().toString();
	}

	public static void main(String[] args) throws MalformedURLException {
		SauceLabIOSDriverIpaSample sample = new SauceLabIOSDriverIpaSample();
		sample.setUp();
